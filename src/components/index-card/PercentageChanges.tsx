  ...
  return (
    <div className="grid grid-cols-3 gap-3 mb-4 bg-stake-card rounded-lg p-3">
      <div className="text-center">
        ...
        <p className={`text-sm font-semibold ${getPercentageColor(percentChange1h)} transition-colors duration-300`}>
          {formatPercentage(percentChange1h)}
        </p>
      </div>
      <div className="text-center">
        <h4 className="text-xs text-stake-muted">6h %</h4>
        <p className={`text-sm font-semibold ${getPercentageColor(percentChange6h)} transition-colors duration-300`}>
          {formatPercentage(percentChange6h)}
        </p>
      </div>
      <div className="text-center">
        <h4 className="text-xs text-stake-muted">24h %</h4>
        <p className={`text-sm font-semibold ${getPercentageColor(gainPercentage)} transition-colors duration-300`}>
